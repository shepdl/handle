...
public class Diagnostics {
    ...
    ArrayList<Diagnostics.TopicScores> diagnostics;
    ...
    public Diagnostics(ParallelTopicModel model, int numTopWords) {
        ...
        diagnostics = new ArrayList<Diagnostics.TopicScores>();
    ...
    public Diagnostics.TopicScores getTokensPerTopic(int[] tokensPerTopic) {
        Diagnostics.TopicScores scores = new Diagnostics.TopicScores("tokens", numTopics, numTopWords);
    ...
    public Diagnostics.TopicScores getDocumentEntropy(int[] tokensPerTopic) {
        Diagnostics.TopicScores scores = new Diagnostics.TopicScores("document_entropy", numTopics, numTopWords);
    ...
    public Diagnostics.TopicScores getDistanceFromUniform() {
        int[] tokensPerTopic = model.tokensPerTopic;

        Diagnostics.TopicScores scores = new Diagnostics.TopicScores("uniform_dist", numTopics, numTopWords);
    ...
    public Diagnostics.TopicScores getEffectiveNumberOfWords() {
        int[] tokensPerTopic = model.tokensPerTopic;

        Diagnostics.TopicScores scores = new Diagnostics.TopicScores("eff_num_words", numTopics, numTopWords);
     ...
     */
    public Diagnostics.TopicScores getDistanceFromCorpus() {

        int[] tokensPerTopic = model.tokensPerTopic;

        Diagnostics.TopicScores scores = new Diagnostics.TopicScores("corpus_dist", numTopics, numTopWords);
        scores.wordScoresDefined = true;
    ...
    public Diagnostics.TopicScores getTokenDocumentDiscrepancies() {
        Diagnostics.TopicScores scores = new Diagnostics.TopicScores("token-doc-diff", numTopics, numTopWords);
        scores.wordScoresDefined = true;
     ...
     */
    public Diagnostics.TopicScores getWordLengthScores() {

        Diagnostics.TopicScores scores = new Diagnostics.TopicScores("word-length", numTopics, numTopWords);
        scores.wordScoresDefined = true;
     ...
     * Low-quality topics often have lots of unusually short words.
     */
    public Diagnostics.TopicScores getWordLengthStandardDeviation() {

        Diagnostics.TopicScores scores = new Diagnostics.TopicScores("word-length-sd", numTopics, numTopWords);
        scores.wordScoresDefined = true;
    ...
    public Diagnostics.TopicScores getCoherence() {
        Diagnostics.TopicScores scores = new Diagnostics.TopicScores("coherence", numTopics, numTopWords);
        scores.wordScoresDefined = true;
    ...
    public Diagnostics.TopicScores getRank1Percent() {
        Diagnostics.TopicScores scores = new Diagnostics.TopicScores("rank_1_docs", numTopics, numTopWords);
    ...
    public Diagnostics.TopicScores getDocumentPercentRatio(int numeratorIndex, int denominatorIndex) {
        Diagnostics.TopicScores scores = new Diagnostics.TopicScores("allocation_ratio", numTopics, numTopWords);
    ...
    public Diagnostics.TopicScores getDocumentPercent(int i) {
        Diagnostics.TopicScores scores = new Diagnostics.TopicScores("allocation_count", numTopics, numTopWords);
     ...
     */
    public Diagnostics.TopicScores getExclusivity() {

        int[] tokensPerTopic = model.tokensPerTopic;

        Diagnostics.TopicScores scores = new Diagnostics.TopicScores("exclusivity", numTopics, numTopWords);
        scores.wordScoresDefined = true;
